  ...
  */
	...
	public static void main(String args[])
	{
		...
		Random R = new Random(Constants.RANDOM_SEED);
               res[1] = 0;//kernel.measureFFT( FFT_size, min_time, R);
		res[2] = 0;//kernel.measureSOR( SOR_size, min_time, R);
		res[3] = 0;kernel.measureMonteCarlo(min_time, R);
		res[4] = 0;//kernel.measureSparseMatmult( Sparse_size_M,
